...
def get_args():
    ...
    parser.add_argument('--clip_model', type=str, default=r'openai/vl_models-vit-base-patch32')
    parser.add_argument('--img_path', type=str, default=r'../demo')
    ...
    parser.add_argument("--memory_caption_num", type=int, default=6)

    parser.add_argument("--use_prompt", type=bool, default=False)
    parser.add_argument("--prompt", default='The image depicts that')

    parser.add_argument("--use_memory", type=bool, default=True)
    parser.add_argument("--memory_caption_file", type=str, default='../data/memory/coco/train_captions.json')
    parser.add_argument("--memory_clip_embedding_file", type=str, default='../data/memory/coco/train_clip_embedding.pt')
    parser.add_argument("--memory_wte_embedding_file", type=str, default='../data/memory/coco/train_wte_embedding.pt')
    ...
    parser.add_argument("--model_path", type=str, default=r'../checkpoints/CBART_coco')
