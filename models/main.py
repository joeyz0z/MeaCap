...
if __name__ == "__main__":
    ...
    parser.add_argument('--conzic_top_k', type=int, default=50)
    ...
    model_path = '/media/xieyan/Hard Disk2/pretrain_model/CBART_ar_COCO'
    if args.do_sample:
        if args.top_k > 0:
    ...
    if args.conzic_sample:
        log_file = f'../logs/conzic_{args.dataset}_alpha{args.alpha}_beta{args.beta}_detect_{args.use_detect}_wordNet{args.wordnet}.log'
    else:
    ...
    if args.conzic_sample:
        if args.use_detect:
            ...
            detect_model = None
        save_prefix = f'conzic_coco_alpha{args.alpha}_beta{args.beta}_{detect_model.__class__.__name__}_memory{args.use_memory}.json'
        result_dict = {}
